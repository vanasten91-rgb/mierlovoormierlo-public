...
final class Newsroom_Secondary_Read_REST_Controller {
    private const NAMESPACE = 'mvm-hub/v1';

    public function register_routes(): void {
        $this->register_list_route( '/newsroom/media', Capabilities::MEDIA_VIEW, 'mvm_hub4_media_view', 'media' );
        $this->register_list_route( '/newsroom/dossiers', Capabilities::DOSSIERS_VIEW, 'mvm_hub4_dossier_view', 'dossiers' );
        $this->register_list_route( '/newsroom/corrections', Capabilities::CORRECTIONS_VIEW, 'mvm_hub4_correction_view', 'corrections' );
        $this->register_list_route( '/newsroom/distribution', Capabilities::DISTRIBUTION_VIEW, 'mvm_hub4_distribution_view', 'distribution' );
    }
        ...
        register_rest_route(
            ...
            array(
                ...
                'callback'            => function ( \WP_REST_Request $request ) use ( $method ): \WP_REST_Response {
                    $model = new Newsroom_Secondary_Read_Model();
